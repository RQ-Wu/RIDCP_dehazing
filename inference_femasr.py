...
from basicsr.archs.dehaze_vq_arch import VQDehazeNet
from basicsr.archs.dehaze_vq_unet_arch import VQUNetDehazeNet
...
# from basicsr.archs.dehamer_arch import Dehamer
# from basicsr.archs.msbdn_arch import MSBDNNet
pretrain_model_url = {
...
def main():
    ...
    # set up the model
    sr_model = VQWeightDehazeNet(codebook_params=[[64, 1024, 512]], LQ_stage=True, scale_factor=args.out_scale, use_weight=False, weight_alpha=-21.25).to(device)
